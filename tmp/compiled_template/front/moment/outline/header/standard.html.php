<?php /* Template_ 2.2.7 2022/11/04 16:47:29 /www/unpobby1_godomall_com/data/skin/front/moment/outline/header/standard.html 000003753 */  $this->include_("includeWidget","dataCartGoodsCnt","dataBanner");?>
<div id="header">
    ...
    <div class="header_top">
        <div class="header_top_cont">
            ...
            <ul class="top_member_box">
				<li>제휴 회원사 : <?php echo $TPL_VAR["whData"]["whspecial"]?> 명 / 전체 회원수 : <?php echo $TPL_VAR["whData"]["whtotal"]?> 명</li>
