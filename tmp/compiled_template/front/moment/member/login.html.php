<?php /* Template_ 2.2.7 2021/07/05 10:03:09 /www/unpobby1_godomall_com/data/skin/front/moment/member/login.html 000011823 */ ?>
...
<?php if($TPL_VAR["usePaycoLogin"]){?>
					<a class="btn_payco_login js_btn_payco_login" href="#"><img src="/data/skin/front/moment/img/etc/pc_payco.png" alt="<?php echo __('PAYCO')?> <?php echo __('아이디 로그인')?>"></a>
<?php }?>
<?php if($TPL_VAR["useFacebookLogin"]){?>
					<a href="#" class="btn_facebook_login js_btn_facebook_login" href="#" data-facebook-url="<?php echo $TPL_VAR["facebookUrl"]?>"><img src="/data/skin/front/moment/img/etc/pc_facebook.png" alt="<?php echo __('FACEBOOK')?> <?php echo __('아이디 로그인')?>"></a>
<?php }?>
<?php if($TPL_VAR["useNaverLogin"]){?>
					<a href="#" class="btn_naver_login js_btn_naver_login" href="#" data-naver-url="<?php echo $TPL_VAR["naverUrl"]?>"><img src="/data/skin/front/moment/img/etc/pc_naver.png" alt="<?php echo __('네이버')?> <?php echo __('아이디 로그인')?>"></a>
<?php }?>
<?php if($TPL_VAR["useKakaoLogin"]){?>
					<a href="#" class="btn_kakao_login js_btn_kakao_login" data-kakao-type="login" data-return-url="<?php echo $TPL_VAR["kakaoReturnUrl"]?>"> <img src="/data/skin/front/moment/img/etc/pc_kakao.png" alt="<?php echo __('카카오')?> <?php echo __('아이디 로그인')?>"></a>
<?php }?>
<?php if($TPL_VAR["useWonderLogin"]){?>
					<a href="#" class="btn_wonder_login js_btn_wonder_login" data-wonder-type="login" data-wonder-url="<?php echo $TPL_VAR["wonderReturnUrl"]?>"> <img src="/data/skin/front/moment/img/etc/pc_wonder.png" alt="<?php echo __('위메프')?> <?php echo __('아이디로 로그인')?>"></a>
<?php }?>
<?php if($TPL_VAR["useAppleLogin"]){?>
					<a href="#" class="btn_apple_login js_btn_apple_login">
						<img id="apple_btn" src="/data/skin/front/moment/img/etc/pc_apple.png" alt="<?php echo __('Apple')?> <?php echo __('아이디 로그인')?>">
...
<script type="text/javascript" src="/data/skin/front/moment/js/jquery/jquery.serialize.object.js"></script>
